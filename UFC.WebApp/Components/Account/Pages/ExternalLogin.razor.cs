...
namespace UFC.WebApp.Components.Account.Pages;
...
public partial class ExternalLogin : ComponentBase
{
    ...
    [Inject]
    public required IUserStore<ApplicationUser> UserStore { get; set; }

    [Inject]
    public required IEmailSender<ApplicationUser> EmailSender { get; set; }
    ...
    [Inject]
    public required ILogger<ExternalLogin> Logger { get; set; }
