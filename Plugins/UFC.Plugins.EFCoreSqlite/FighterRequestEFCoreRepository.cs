...
namespace UFC.Plugins.EFCoreSqlite;

public class FighterRequestEFCoreRepository : IFighterRequestRepository
{
    private readonly IDbContextFactory<UfcSqliteContext> contextFactory;

    public FighterRequestEFCoreRepository(IDbContextFactory<UfcSqliteContext> contextFactory)
    {
